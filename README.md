...
We'll create this setup in 7 steps. Or, [clone/download](https://github.com/codylindley/simple-react-webpack-setup-4-apps) this code then run `npm install` and skip to the last step.
