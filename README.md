...
We'll create this setup in seven steps. Or, [clone/download](https://github.com/codylindley/simple-react-webpack-setup-4-apps) this code then run `npm install`. Next follow step 1, then skip to the last step.
